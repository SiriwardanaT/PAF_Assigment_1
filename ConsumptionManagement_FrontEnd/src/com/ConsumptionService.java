...
public class ConsumptionService {
	...
	public static String getAllConsumptions() throws ClassNotFoundException, SQLException {
		...
		if(con == null) {
			...
			while(rs.next()) {
				...
				output +="<td><input id='btnRemove' name='btnRemove' type='button' value='Remove' class='btnRemove btn btn-danger' data-cid='" +rs.getString(1)+ "'>" +"</td>";
				output +="<td><input id='btnUpdate' name='btnUpdate' type='button' value='Update' class='btnUpdate btn btn-info' data-cid='" +rs.getString(1)+ "'>" +"</td>";
				output += "</tr>";
			}
			output += "</table>";
			return output;
	...
	//Add Consumption record
		...
		public static String updateConsumption(int status , double uprice, int id) throws ClassNotFoundException, SQLException {
			Connection con = DbConnection.getDbConnection();
			String output = "";
			if(con == null) {
				return "";
